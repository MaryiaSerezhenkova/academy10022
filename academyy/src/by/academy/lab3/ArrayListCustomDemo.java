...
public class ArrayListCustomDemo<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
      ...
      // System.out.println(obj.binarySearch(-128));
       ...
       System.out.println(obj.findSimpleNumbers());
    }
...
//     public static  ArrayList <Integer> findAllFibonacci(Integer [] items) {
//        ArrayListCustom<Integer> obj = new ArrayListCustom<>(items);
//        ArrayList <Integer> result = new ArrayList<>();
//        Integer maxValue = maxElement(items);
//        Integer[] fibonacciArray = fibonacciArray(maxValue);
// 
//        for (int i = 0; i < obj.size(); i++) {
//            Integer value = obj.get(i);
// 
//            for (int j = 0; j < fibonacciArray.length; j++) {
//                if (value != fibonacciArray[j]) {
//                    continue;
//                }
//                if (value == fibonacciArray[j]) {
//                    result.add(value);
//                    j = 0;
//                }
//                if (value != fibonacciArray[(fibonacciArray.length - 1)]) {
//                    j = 0;
//                    break;
//                }
//            }
...
//        return result;
//    }
      private static Integer[]fibonacciArray(Integer n) {
