...
//			}
//		}));
		Searchable s = car->car.getType().equals(CarTypes.COMPACT);
		carDemo.getCarsNumber(cars, (Car car) -> car.getType().equals(CarTypes.SPORT));
		carDemo.getCarsNumber(cars, s);
		
		System.out.println(carDemo.getCarsNumber(cars, (Car car) -> car.getCost()>14000));
	}
